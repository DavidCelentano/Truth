...
//  }()
//  
//  private var weaponBestTypeLabel = UILabel.whiteLabel()
//  private var weaponBestTypeButton: UIButton = {
//    let b = UIButton(type: .system)
//    let bool = UserDefaults.standard.value(forKey: "weaponBestTypeEnabled") as? Bool ?? true
//    b.tintColor = bool ? .green : .red
//    b.setImage(bool ? #imageLiteral(resourceName: "CheckIcon") : #imageLiteral(resourceName: "XIcon"), for: .normal)
//    b.addTarget(self, action: #selector(weaponBestTypeTapped), for: .touchUpInside)
//    return b
//  }()
//  
...
//    weaponBestTypeLabel.text = "The deadliest weapon type of the current character"
...
//      make.size.equalTo(44)
//    }
//    weaponBestTypeButton.snp.makeConstraints { (make) in
//      make.size.equalTo(44)
//    }
...
//    
//    let weaponBestTypeStackView = UIStackView(arrangedSubviews: [weaponBestTypeButton, weaponBestTypeLabel])
...
//    
//    
//    let statsStackView = UIStackView(arrangedSubviews: [subclassStackView, primaryStackView, specialStackView, heavyStackView, lightLevelStackView, overallKDStackView, overallKDAStackView, overallWinLossStackView, overallCombatRatingStackView, weaponBestTypeStackView, timePlayedStackView])
...
//  }
//  @objc private func weaponBestTypeTapped() {
//    let bool = UserDefaults.standard.value(forKey: "weaponBestTypeEnabled") as? Bool ?? false
//    delegate?.setEnabled(to: !bool, for: .weaponBestType)
//    weaponBestTypeButton.tintColor = bool ? .red : .green
//    weaponBestTypeButton.setImage(!bool ? #imageLiteral(resourceName: "CheckIcon") : #imageLiteral(resourceName: "XIcon"), for: .normal)
//  }
